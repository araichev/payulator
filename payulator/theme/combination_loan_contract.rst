...
.. list-table::
    ...
    * - **Payment Schedule**
      - {{ num_payments_interest_only }} consecutive {{ payment_freq }} payments of {{ "{:,.2f}$".format(periodic_payment.interest_only) }} beginning on {{ first_payment_date.interest_only }} and ending on {{ last_payment_date.interest_only }}, which covers the interest-only portion of the loan.
        Then {{ num_payments - num_payments_interest_only }} consecutive {{ payment_freq }} payments of {{ "{:,.2f}$".format(periodic_payment.amortized) }} beginning on {{ first_payment_date.amortized }} and ending on {{ last_payment_date.amortized }}, which covers the amortized portion of the loan.
